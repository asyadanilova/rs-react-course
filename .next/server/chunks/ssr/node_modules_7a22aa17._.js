module.exports = {
  ...
  '[project]/node_modules/set-cookie-parser/lib/set-cookie.js [app-ssr] (ecmascript)':
    (__turbopack_context__) => {
      'use strict';
...
*/ function splitCookiesString(cookiesString) {
  ...
  '[project]/node_modules/react-router/dist/development/index.js [app-ssr] (ecmascript)':
    (__turbopack_context__) => {
      'use strict';
...
`,
        ...
        function isSameRoute(newRoute, existingRoute) {
          ...
          return newRoute.children.every((aChild, i) =>
            existingRoute.children?.some((bChild) =>
        ...
        function useHref(to, { relative } = {}) {
          invariant(
            useInRouterContext(), // TODO: This error is probably because they somehow have 2 versions of the
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === '/' ? '*' : `${parentPath}/*`}">.`
        ...
        var defaultErrorElement = /* @__PURE__ */ React2.createElement(
        ...
        function mapRouteProperties(route) {
          ...
          if (route.HydrateFallback) {
            ...
            Object.assign(updates, {
              hydrateFallbackElement: React3.createElement(
        ...
        function Navigate({ to, replace: replace2, state, relative }) {
          invariant(
            useInRouterContext(), // TODO: This error is probably because they somehow have 2 versions of
        ...
        var globalObj = ('TURBOPACK compile-time falsy', 0)
          ? 'TURBOPACK unreachable'
        ...
        function BoundaryShell({
          ...
          return /* @__PURE__ */ React5.createElement(
            ...
            /* @__PURE__ */ React5.createElement(
              ...
              /* @__PURE__ */ React5.createElement('title', null, title)
            ),
            /* @__PURE__ */ React5.createElement(
              'body',
              null,
              /* @__PURE__ */ React5.createElement(
                ...
                children,
                renderScripts
                  ? /* @__PURE__ */ React5.createElement(Scripts, null)
                  : null
              )
            )
          );
        ...
        function getRouteComponents(route, routeModule, isSpaMode) {
          ...
          if (route.id === 'root' && routeModule.Layout) {
            return {
              ...(Component4
                ? {
                    element: /* @__PURE__ */ React7.createElement(
                      routeModule.Layout,
                      null,
                      /* @__PURE__ */ React7.createElement(Component4, null)
                    ),
                  }
                : {
              ...
              ...(ErrorBoundary
                ? {
                    errorElement: /* @__PURE__ */ React7.createElement(
                      routeModule.Layout,
                      null,
                      /* @__PURE__ */ React7.createElement(ErrorBoundary, null)
                    ),
                  }
                : {
                    ErrorBoundary,
        ...
        function Links() {
          ...
          return /* @__PURE__ */ React9.createElement(
            ...
            typeof criticalCss === 'string'
              ? /* @__PURE__ */ React9.createElement('style', {
                  dangerouslySetInnerHTML: {
                    __html: criticalCss,
                  },
                })
            ...
            keyedLinks.map(({ key, link }) =>
              isPageLinkDescriptor(link)
                ? /* @__PURE__ */ React9.createElement(PrefetchPageLinks, {
                    key,
                    ...link,
                  })
                : /* @__PURE__ */ React9.createElement('link', {
        ...
        function PrefetchPageLinksImpl({
          ...
          return /* @__PURE__ */ React9.createElement(
            ...
            keyedPrefetchLinks.map(
              (
                { key, link } // these don't spread `linkProps` because they are full link descriptors
              ) =>
...
import(${JSON.stringify(manifest.entry.module)});`;
        ...
        var Link = React10.forwardRef(function LinkWithRef(
          ...
          return shouldPrefetch && !isAbsolute
            ? /* @__PURE__ */ React10.createElement(
                ...
                null,
                link,
                /* @__PURE__ */ React10.createElement(PrefetchPageLinks, {
                  page: href2,
                })
              )
            : link;
          ...
          return /* @__PURE__ */ React12.createElement(
            ...
            context.serverHandoffStream
              ? /* @__PURE__ */ React12.createElement(
                  React12.Suspense,
                  null,
                  /* @__PURE__ */ React12.createElement(StreamTransfer, {
                    context,
                    identifier: 0,
        ...
        var import_cookie = __turbopack_context__.r(
          '[project]/node_modules/cookie/dist/index.js [app-ssr] (ecmascript)'
        );
        ...
        var import_set_cookie_parser = __turbopack_context__.r(
          '[project]/node_modules/set-cookie-parser/lib/set-cookie.js [app-ssr] (ecmascript)'
        );
        function getDocumentHeaders(build, context) {
          return getDocumentHeadersImpl(context, (m) => {
            ...
            invariant3(
              route,
              `Route with id "${m.route.id}" not found in build`
            );
            ...
            if (_build.future.unstable_middleware) {
              if (initialContext == null) {
                ...
                try {
                  ...
                  let error =
                    new Error(`Unable to create initial \`unstable_RouterContextProvider\` instance. Please confirm you are returning an instance of \`Map<unstable_routerContext, unknown>\` from your \`getLoadContext\` function.
...
Error: ${e instanceof Error ? e.toString() : e}`);
            ...
            if (url.pathname.endsWith('.data')) {
              ...
              if (_build.unstable_getCriticalCss) {
                ...
                criticalCss =
                  await getDevServerHooks()?.getCriticalCss?.(pathname);
              }
...
${String(error)}`;
  ...
  '[project]/node_modules/react-router/dist/development/dom-export.js [app-ssr] (ecmascript)':
    (__turbopack_context__) => {
      'use strict';
      ...
      var { m: module, e: exports } = __turbopack_context__;
      {
        ...
        var import_react_router2 = __turbopack_context__.r(
          '[project]/node_modules/react-router/dist/development/index.js [app-ssr] (ecmascript)'
        );
        var ssrInfo = null;
        var router = null;
        ...
        function createHydratedRouter({ unstable_getContext }) {
          ...
          if (!ssrInfo.stateDecodingPromise) {
            ...
            (0, import_react_router2.UNSAFE_invariant)(
              stream,
              'No stream found for single fetch decoding'
            );
            ssrInfo.context.stream = void 0;
            ssrInfo.stateDecodingPromise = (0,
            import_react_router2.UNSAFE_decodeViaTurboStream)(stream, window)
              .then((value) => {
          ...
          if (ssrInfo.context.isSpaMode) {
            ...
            if (hydrationData && hydrationData.errors) {
              ...
              import_react_router2.UNSAFE_deserializeErrors)(
          ...
          let router2 = (0, import_react_router2.UNSAFE_createRouter)({
            ...
            hydrationData,
            hydrationRouteProperties:
              import_react_router2.UNSAFE_hydrationRouteProperties,
            mapRouteProperties: import_react_router2.UNSAFE_mapRouteProperties,
            future: {
              unstable_middleware: ssrInfo.context.future.unstable_middleware,
            },
            dataStrategy: (0,
            import_react_router2.UNSAFE_getTurboStreamSingleFetchDataStrategy)(
              () => router2,
              ssrInfo.manifest,
              ssrInfo.routeModules,
              ssrInfo.context.ssr,
            ...
            import_react_router2.UNSAFE_getPatchRoutesOnNavigationFunction)(
              ssrInfo.manifest,
              ssrInfo.routeModules,
              ssrInfo.context.ssr,
          ...
          router2.createRoutesForHMR =
            /* spacer so ts-ignore does not affect the right hand of the assignment */ import_react_router2.UNSAFE_createClientRoutesWithHMRRevalidationOptOut;
          ...
          return (
            ...
            /* @__PURE__ */ React2.createElement(
              ...
              /* @__PURE__ */ React2.createElement(
                ...
                /* @__PURE__ */ React2.createElement(
                  import_react_router2.UNSAFE_RemixErrorBoundary,
                  {
                    location,
                  },
  ...
  '[project]/node_modules/react-router-dom/dist/index.js [app-ssr] (ecmascript)':
    (__turbopack_context__) => {
      ...
      var { m: module, e: exports } = __turbopack_context__;
      {
        ...
        var import_dom = __turbopack_context__.r(
          '[project]/node_modules/react-router/dist/development/dom-export.js [app-ssr] (ecmascript)'
        );
        __reExport(
...
//# sourceMappingURL=node_modules_7a22aa17._.js.map
