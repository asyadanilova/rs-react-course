...
"[project]/.next-internal/server/app/api/generate-csv/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/generate-csv/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const csvBody = items.map((item)=>`${item.name},${item.country},${item.web_pages[0]}`).join('\n');
